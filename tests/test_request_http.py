...
class TestRedirectFollowing:
    ...
    def test_follows_302_redirect(self):
        ...
        redirect_resp = httpx.Response(302, headers={"location": "/final"},
    ...
    def test_returns_non_redirect_immediately(self):
        ...
        normal_resp = httpx.Response(200, text="Not a redirect",
                                     request=httpx.Request("GET", "http://testserver/oracle"))
    ...
    def test_max_redirects(self):
        ...
        redirect_resp = httpx.Response(302, headers={"location": "/loop"},
                                       request=httpx.Request("GET", "http://testserver/oracle"))
    ...
    def test_missing_location_header(self):
        ...
        redirect_resp = httpx.Response(302, request=httpx.Request("GET", "http://testserver/oracle"))
        result = j._followRedirect(redirect_resp, {})
        assert result.status_code == 302
...
class TestRedirectFollowingAsync:
    ...
    async def test_follows_302_redirect(self):
        ...
        with patch.object(j.async_client, 'get', new_callable=AsyncMock, return_value=final_resp):
...
class TestFollowRedirectsFlag:
    ...
    def test_no_redirect_following_when_disabled(self):
        ...
        redirect_resp = httpx.Response(302, headers={"location": "/elsewhere"},
...
class TestMakeRequestSyncPaths:
    ...
    def test_get_querystring(self):
        ...
        with patch.object(j.client, 'get', return_value=httpx.Response(200, text="OK")) as mock:
    ...
    def test_get_cookie(self):
        j = make_job(httpMethod="GET", inputMode="cookie", vulnerableParameter="auth",
                     cookies={"session": "xyz"})
        j.initialize_client()
    ...
    def test_get_with_additionals(self):
        j = make_job(httpMethod="GET", inputMode="parameter",
    ...
    def test_post_form_urlencoded(self):
        j = make_job(httpMethod="POST", inputMode="parameter", postFormat="form-urlencoded",
                     vulnerableParameter="data")
        j.initialize_client()

        with patch.object(j.client, 'post', return_value=httpx.Response(200, text="OK")) as mock:
    ...
    def test_post_json(self):
        j = make_job(httpMethod="POST", inputMode="parameter", postFormat="json",
    ...
    def test_post_multipart(self):
        j = make_job(httpMethod="POST", inputMode="parameter", postFormat="multipart",
    ...
    def test_post_querystring(self):
        j = make_job(httpMethod="POST", inputMode="querystring", postFormat="form-urlencoded")
        j.initialize_client()
...
class TestMakeRequestAsyncPaths:
    ...
    async def test_follow_redirects_async(self):
        ...
        with patch.object(j.async_client, 'get', side_effect=fake_get):
            with patch.object(j, '_followRedirectAsync', new_callable=AsyncMock,
                              return_value=resp) as mock_redir:
